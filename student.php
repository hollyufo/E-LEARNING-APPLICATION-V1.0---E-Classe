                ...
                <div class="container-fluid m123">
                    ...
                    <?php
                            ...
                            if(isset($_POST['save'])){
                                ...
                                $new_student = json_decode($new_student, true);
                    ...
                    <div class="mytable res-table">
                        <table class="table">
                            ...
                            // show data
                                ...
                                $students = json_decode($lists, true); 
