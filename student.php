                ...
                <div class="container-fluid m123">
                    ...
                    <div class="mytable res-table">
                        <table class="table">
                            ...
                            <?php
                              $students = array (
                                array("img"=>"", "name"=>"username1", "Email"=>"user@email.com1", "phone"=>"1234567898A", "enroll1"=>"1234567898A", "date1"=>"08-dec,2021A","svg"=>"08-dec,2021A"),
                                array("name"=>"username2", "Email"=>"user@email.com2", "phone"=>"1234567898B", "enroll2"=>"1234567898B", "date2"=>"08-dec,2021B"),
                                array("name"=>"username3", "Email"=>"user@email.com3", "phone"=>"1234567898C", "enroll3"=>"1234567898C", "date3"=>"08-dec,2021C"),
                                array("name"=>"username4", "Email"=>"user@email.com4", "phone"=>"1234567898D", "enroll4"=>"1234567898D", "date4"=>"08-dec,2021D")
                              );
                              foreach ($students as $student) {
                                echo '<tr class="mytr">';
                                foreach ($student as $value1) {
                                    echo '<td class="mytd">' . $value1 . '</td>';    
                                }
                                echo '</tr>';
                            } 
                            ?>
                              <tr class="mytr">
                                <th><img src="./assets/img/pexels-photo-2379004 1 (2).png" alt="user1"></th>
                                <td class="mytd">username</td>
                                <td class="mytd">user@email.com</td>
                                <td class="mytd">7305477760</td>
                                <td class="mytd">1234567898</td>
                                <td class="mytd">08-dec,2021</td>
                                <td class="mytd">
                              ...
                              <tr class="mytr">
                                <th scope="row"><img src="./assets/img/pexels-photo-2379004 1 (2).png" alt="user1"></th>
                                <td class="mytd">username</td>
                                <td class="mytd">user@email.com</td>
                                <td class="mytd">7305477760</td>
                                <td class="mytd">1234567898</td>
                                <td class="mytd">08-dec,2021</td>
                                <td class="mytd">
                                    <svg class="smg1" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
