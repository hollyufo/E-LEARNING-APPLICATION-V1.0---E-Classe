            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid m123">
                    <div class="mycontainer2 border-bottom">
                        <p class="stitle1">Students List</p>
                        <ul class="myul2">
                            <li>
                            ...
                            <li>
                                <a type="button" class="add" data-bs-toggle="modal" data-bs-target="#staticBackdrop">ADD NEW STUDENT</a>
                            </li>
                        </ul>
                    </div>
                    <div class="mytable res-table">
                        <table class="table">
                            <thead>
                              <tr>
                                <th scope="col"></th>
                            ...
                            <?php
                                ...
                                while($student = mysqli_fetch_assoc($result)) {
                                    echo '<tr class="mytr">';
                                    echo '<th><img src="./assets/img/pexels.png" alt="user1"></th>';
                                    echo '<td class="mytd">'.$student['fname'].'</td>';
                                    echo '<td class="mytd">'.$student['Email'].'</td>';
                                    echo '<td class="mytd">'.$student['Phone'].'</td>';
                                    echo '<td class="mytd">'.$student['EnrollNumber'].'</td>';
                                    echo '<td class="mytd">'.$student['AdmissionDate'].'</td>';
                                    echo '
                                    <td class="mytd">
                                    <!-- Modal start -->
                ...
                <div class="modal-body">
                    <form id='addd' method="post" action="./function/create.php">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="phone" class="form-control" id="phone" aria-describedby="Recipient's username" >
                        </div>
                        <div class="mb-3">
                            <label for="enroolnum" class="form-label">enroolnum</label>
                            <input type="number" name="enroolnum" class="form-control" id="enrollnum" aria-describedby="Recipient's username" >
                        </div>
                        <div class="mb-3">
