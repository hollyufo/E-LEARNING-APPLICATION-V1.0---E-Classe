                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            are u sure u want to delet '.$courses['cname'].' ?  <br> this action is irreversible.
                                          </div>
                                          <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                            <a href="./removecourse.php?id='.$courses['id'].'" type="button" class="btn btn-danger">DELETE STUDENT</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
