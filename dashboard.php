                <?php
                    ...
                    require './assets/function/db.php';
                    // for students
                    ...
                    // paiments
                    $sql2 = "SELECT  SUM(Blanaceamount) FROM payment_details";
                ...
                <div class="container-fluid">
                    <di class="row ms12">
                        <div class="card col-md-2 card1 mymg">
                            ...
                            <p class="mypr1"><?php  echo $rowcount ?></p>                            
                        </div>
                        <div class="card col-md-2 card2 mymg">
                            ...
                            <p class="mypr1"><?php  echo $rowcount1 ?></p>                            
                        </div>
                        <div class="card col-md-2 card3 mymg">
                            ...
                            <p class="mypr1"><span class="myspan">DHS</span> <?php  echo $rowcount2 ?></p>                            
                        </div>
                        <div class="card col-md-2 card4 mymg">
